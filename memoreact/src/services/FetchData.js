export default class FetchData {
   ...
   * le token est indispensable pour toute communication avec le serveur
   * 
   * @returns promise
   */
  getToken() {
  ...
  /**
   *  Récupère les termes (rubriques) d'un utilisateur
   * @param {object} user 
   * @param {string} token
   *  
   * @returns promise 
  ...
  /**
   * Récupère les cards (cartes) d'un utilisateur
   * @param {object} user 
   * @param {string} token 
